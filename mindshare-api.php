...
if(!defined('MAPI_PLUGIN_SLUG')) {
	define('MAPI_PLUGIN_SLUG', dirname(plugin_basename(__FILE__))); // mindshare-api
}

if(!defined('MAPI_DIR_PATH')) {
	define('MAPI_DIR_PATH', plugin_dir_path(__FILE__)); // /.../wp-content/plugins/mindshare-api/
}
